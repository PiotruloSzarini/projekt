    ...
    return (
        <div>
            <TopicInfo chapterName="Matura Podstawowa" progress={75} link="/dashboard/kursy/" backgroundColor="#1180F6">
                <LessonCard title="Lekcja 1" backgroundColor="#1180F6" progress={100} count={1} />
                <LessonCard title="Lekcja 2" backgroundColor="#1180F6" progress={50} count={2} />
                <LessonCard title="Lekcja 3" backgroundColor="#1180F6" progress={0} count={3} />
            </TopicInfo>
        </div>
    );
}